    ...
    <div class="relative container px-4 pt-12 md:pt-20 mx-auto">
      ...
      <div class="flex flex-wrap -mx-4 -mb-4 md:mb-0">
        <div class="w-full md:w-1/2 px-4 mb-4 md:mb-0">
          ...
          <header>
            <img alt="Vue logo" class="logo" src="../assets/open-sysconf-logo-start-page.png" width="256" height="192" />

            <div class="wrapper">
              <StartLogoSlogan msg="Stay Positive!" />
            </div>
          </header>
          ...
          <div class="mt-3 p-10">
            <WelcomeItem>
              ...
              <template #heading>Open SysConf'26</template>

              Восьмая ежегодная конференция <router-link to="/2026">Welcome!</router-link>
            </WelcomeItem>
